...
var TouchEventDoService$WonderEventmanager = require("../TouchEventDoService.bs.js");
var HandlePointDomEventDoService$WonderEventmanager = require("./HandlePointDomEventDoService.bs.js");
...
function _getLocationInView(touchDomEvent, po) {
  return HandlePointDomEventDoService$WonderEventmanager.getLocationInView(touchDomEvent, _getLocation, po);
}

function _getMovementDelta(touchDomEvent, po) {
  return HandlePointDomEventDoService$WonderEventmanager.getMovementDelta(_getLocation(touchDomEvent, po), TouchEventDoService$WonderEventmanager.getLastXY(po.eventRecord), po);
}
...
function _convertTouchDomEventToTouchEvent(eventName, touchDomEvent, po) {
  return {
          ...
          locationInView: HandlePointDomEventDoService$WonderEventmanager.getLocationInView(touchDomEvent, _getLocation, po),
...
function setLastXY(po, lastX, lastY) {
  return {
          eventRecord: TouchEventDoService$WonderEventmanager.setLastXY(lastX, lastY, po.eventRecord),
          canvas: po.canvas,
          body: po.body,
          browser: po.browser
        };
