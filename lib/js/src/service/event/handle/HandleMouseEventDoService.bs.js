...
var MouseEventDoService$WonderEventmanager = require("../MouseEventDoService.bs.js");
...
function getLocationInView(mouseDomEvent, po) {
  return HandlePointDomEventDoService$WonderEventmanager.getLocationInView(mouseDomEvent, getLocation, po);
}
...
function getMovementDelta(mouseDomEvent, po) {
  if (_isPointerLocked()) {
    ...
    return HandlePointDomEventDoService$WonderEventmanager.getMovementDelta(getLocation(mouseDomEvent, po), MouseEventDoService$WonderEventmanager.getLastXY(po.eventRecord), po);
  }
}
...
function convertMouseDomEventToMouseEvent(eventName, mouseDomEvent, po) {
  return {
          ...
          locationInView: HandlePointDomEventDoService$WonderEventmanager.getLocationInView(mouseDomEvent, getLocation, po),
...
function setLastXY(lastX, lastY, po) {
  return {
          eventRecord: MouseEventDoService$WonderEventmanager.setLastXY(lastX, lastY, po.eventRecord),
          canvas: po.canvas
        };
}
