...
function create(param) {
  return {
          eventRecord: {
            ...
            mouseDomEventDataArrMap: MutableSparseMap$WonderEventmanager.createEmpty(undefined, undefined),
            keyboardDomEventDataArrMap: MutableSparseMap$WonderEventmanager.createEmpty(undefined, undefined),
            touchDomEventDataArrMap: MutableSparseMap$WonderEventmanager.createEmpty(undefined, undefined),
            customGlobalEventArrMap: MutableHashMap$WonderEventmanager.createEmpty(undefined, undefined),
            customGameObjectEventArrMap: MutableHashMap$WonderEventmanager.createEmpty(undefined, undefined),
            mouseEventData: {
              lastX: undefined,
              lastY: undefined,
              isDrag: false
