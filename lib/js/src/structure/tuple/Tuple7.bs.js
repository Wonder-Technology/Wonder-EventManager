  ...
  return Result$WonderEventmanager.bind(resultData1, (function (data1) {
                return Result$WonderEventmanager.bind(resultData2, (function (data2) {
                              return Result$WonderEventmanager.bind(resultData3, (function (data3) {
                                            return Result$WonderEventmanager.bind(resultData4, (function (data4) {
                                                          return Result$WonderEventmanager.bind(resultData5, (function (data5) {
                                                                        return Result$WonderEventmanager.bind(resultData6, (function (data6) {
                                                                                      return Result$WonderEventmanager.mapSuccess(resultData7, (function (data7) {
                                                                                                    return [
                                                                                                            data1,
                                                                                                            data2,
                                                                                                            data3,
