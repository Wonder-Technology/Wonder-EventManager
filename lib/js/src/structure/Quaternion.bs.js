...
var Angle$WonderEventmanager = require("./Angle.bs.js");
var Vector3$WonderEventmanager = require("./Vector3.bs.js");
...
function setFromEulerAngles(param) {
  var halfToRad = 0.5 * Angle$WonderEventmanager.getDegToRad(undefined);
...
function getEulerAngles(quat) {
  ...
  return Vector3$WonderEventmanager.scale(/* Float */0, _getEulerAngles(quat), rad_to_deg);
}

function setFromAxisAngle(angle, axis) {
  var match = Vector3$WonderEventmanager.normalize(axis);
  var angle$1 = angle * 0.5 * Angle$WonderEventmanager.getDegToRad(undefined);
...
exports.setFromMatrix = setFromMatrix;
